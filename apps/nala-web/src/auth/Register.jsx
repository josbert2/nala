...
export default function Register () {
  ...
  const oauth = () => setError('El registro con GitHub/Google no está disponible en modo local — usá tu correo.')
          ...
          <div className="lg-cardwrap">
            <div className="lg-card">
              <div className="lg-header">
                ...
                <h1 className="lg-title">Creá tu cuenta</h1>
                <p className="lg-sub">Empezá a usar Nala en un minuto</p>
              </div>
              ...
              <form className="lg-form" onSubmit={submit}>
                <label className="lg-label" htmlFor="rg-email">Correo electrónico</label>
                <input id="rg-email" className="lg-input" type="email" autoComplete="email" required
                  placeholder="Ingresá tu correo" value={email} onChange={(e) => setEmail(e.target.value)} />
                <label className="lg-label" htmlFor="rg-pass">Contraseña</label>
                <input id="rg-pass" className="lg-input" type="password" autoComplete="new-password" required minLength={6}
                ...
                <button className="lg-continue" type="submit" disabled={busy}>
                  <span>{busy ? 'Creando…' : 'Crear cuenta'}</span>
              ...
              <div className="lg-footer">
                <p className="lg-footer-action">¿Ya tenés cuenta? <a href="/login">Iniciá sesión</a></p>
